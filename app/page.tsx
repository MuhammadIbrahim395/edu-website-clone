    ...
    <section className="header">
        <nav>
            ...
            <div className="nav-links" id="navLinks">
                ...
                <ul>
                  <Link  href="./"> <li><a href="about.html">Home</a></li></Link> 
                  <Link  href="./course"> <li><a href="about.html">Course</a></li></Link> 
                  <Link  href="./blog"> <li><a href="about.html">Blog</a></li></Link> 
                  <Link  href="./about"> <li><a href="about.html">About</a></li></Link> 
                  <Link  href="./contact"> <li><a href="about.html">Contact</a></li></Link> 
                </ul>
            </div>
